...
SEARCH_PROCEDURES = [
['mh_HillClimbing', {'MAX_TRIALS': 100, 'RUNS':20, 'TRESHOLD':10}],
['mh_LocalSearch',  {'MAX_TRIALS': 100, 'RUNS':20, 'TRESHOLD':0, 'CRITERION':'TA'}],
['mh_LocalSearch',  {'MAX_TRIALS': 100, 'RUNS':20, 'TRESHOLD':0, 'CRITERION':'RRT'}],
['mh_LocalSearch',  {'MAX_TRIALS': 100, 'RUNS':20, 'TRESHOLD':10, 'CRITERION':'TA'}],
['mh_LocalSearch',  {'MAX_TRIALS': 100, 'RUNS':20, 'TRESHOLD':10, 'CRITERION':'RRT'}],
...
['mh_RandomSearch', {'MAX_TRIALS': 10000}],
['mh_RandomWalk', {'MAX_TRIALS': 100}],
['mh_HillClimbing', {'MAX_TRIALS': 100}],
