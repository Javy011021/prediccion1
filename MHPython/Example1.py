...
parameters = {'MAX_TRIALS': 2000, \
              'OBJECTIVE_MAX':False}
set_parameters(parameters)
print()
print('Execute Random Search with parameters ',parameters)
solRS = mh_RandomSearch()
print()
print('Solution obtained by Random Search')
print(solRS)
...
print()
print('Comparison of the results of the two search procedures with both objetive')
print('RS min:',solRS, 'with evalution',objective_function(solRS))
print('HC min:',solHC, 'with evalution',objective_function(solHC))
print('RS max:',solRS_max, 'with evalution',objective_function(solRS_max))
print('HC max:',solHC_max, 'with evalution',objective_function(solHC_max))
